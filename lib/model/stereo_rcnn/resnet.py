...
def conv3x3(in_feature_maps, out_feature_maps, stride=1):
    """3x3 convolution with padding ("SAME"-Padding in Tensorflow)"""
    return nn.Conv2d(in_feature_maps, out_feature_maps, kernel_size=3, stride=stride,
...
class ResNet(nn.Module):
    """Adaptive ResNet implementation (https://arxiv.org/abs/1512.03385)

    :argument block: Controls the type of blocks used, either Residual Blocks or Bottleneck blocks
    :argument layers: Controls the number of stacked blocks of a specific type
    """
